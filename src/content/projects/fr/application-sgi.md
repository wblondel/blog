...
| **Recueillir, analyser et mettre à jour les informations sur une version d'une solution applicative** | Backlog suivi sur [Trello](https://trello.com/b/eIcnlMPs/application-sgi) + classeur [Gestion_Projet_App_SGI.xlsx](/documents/E6/Gestion_Projet_App_SGI.xlsx) (vélocité, charge par développeur, story points livrés par sprint), historique Git riche (commits *feat:* / *fix:* / *refactor:* / *test:*), audit applicatif via `owen-it/laravel-auditing` qui trace toutes les modifications par utilisateur. |
