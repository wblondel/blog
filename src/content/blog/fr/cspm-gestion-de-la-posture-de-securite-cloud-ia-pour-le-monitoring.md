...
* **Infrastructure éphémère :** Dans un environnement DevSecOps, l'infrastructure est définie comme du code (IaC) et est très éphémère. Les machines virtuelles et les [conteneurs](/fr/securite-des-conteneurs-detection-danomalies-dans-kubernetes) sont créés et détruits en quelques minutes. Les auditeurs humains ne peuvent physiquement pas suivre ce rythme de changement.
