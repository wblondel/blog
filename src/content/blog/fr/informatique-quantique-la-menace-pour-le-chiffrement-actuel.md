...
Des acteurs étatiques interceptent et exfiltrent actuellement d'immenses volumes de données d'entreprise et gouvernementales chiffrées. Ils savent qu'ils ne peuvent pas lire aujourd'hui les clés AES enveloppées dans RSA. Cependant, ils stockent ces pétaoctets de données chiffrées dans d'immenses centres de données. Dès qu'ils atteindront la capacité quantique, ils déchiffreront rétrospectivement les données stockées.
