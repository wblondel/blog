...
Des acteurs étatiques interceptent et exfiltrent actuellement d'immenses volumes de données d'entreprise et gouvernementales chiffrées grâce à des techniques sophistiquées d'[analyse du trafic réseau](/fr/analyse-du-trafic-reseau-nta) et d'interception. Ils savent qu'ils ne peuvent pas lire aujourd'hui les clés AES enveloppées dans RSA. Cependant, ils stockent ces pétaoctets de données chiffrées dans d'immenses centres de données. Dès qu'ils atteindront la capacité quantique, ils déchiffreront rétrospectivement les données stockées.
