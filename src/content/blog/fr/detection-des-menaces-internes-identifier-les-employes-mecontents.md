...
Pour combler ce fossé contextuel, les équipes de sécurité IT déploient l'**[User and Entity Behavior Analytics (UEBA)](/fr/ueba-aller-au-dela)**. L'UEBA s'appuie sur le machine learning non supervisé pour établir un référentiel mathématique du comportement « normal » pour chaque employé individuel et ses groupes de pairs correspondants.
