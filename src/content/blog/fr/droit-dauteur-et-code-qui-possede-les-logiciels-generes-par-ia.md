...
Pour les responsables informatiques et les architectes, cela exige un changement fondamental dans la documentation DevSecOps et une approche vigilante de la gestion de la [dette technique](/fr/dette-technique). Vous devez être en mesure de prouver l'intervention humaine devant un tribunal. Voici quelques stratégies :
