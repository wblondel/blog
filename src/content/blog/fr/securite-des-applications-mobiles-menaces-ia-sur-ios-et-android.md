...
* **Attaques par présentation :** Les attaquants utilisent la technologie deepfake pour contourner la reconnaissance faciale. En collectant quelques photos publiques d'une victime sur les réseaux sociaux, un attaquant peut utiliser l'IA pour générer un modèle 3D animé et très réaliste du visage de la victime. Présenté à la caméra de l'appareil, ce deepfake peut tromper les algorithmes de « détection de vivacité » de l'application en lui faisant croire que l'utilisateur réel cligne des yeux et bouge devant l'écran.
